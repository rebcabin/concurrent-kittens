...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgb76a145}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org18816ed}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org18816ed}}

\subsection{``How did you write this?''}
\label{sec:orgdbc9214}
...
\label{sec:org6b758e4}

From the wiki page:\textsuperscript{\ref{orgb76a145}}
