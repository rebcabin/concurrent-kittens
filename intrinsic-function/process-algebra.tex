...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org001540d}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org9c56192}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org9c56192}}

\subsection{``How did you write this?''}
\label{sec:org07de5e4}
...
\label{sec:org6b45bc9}

From the wiki page:\textsuperscript{\ref{org001540d}}
...
rename preexisting \(z\)'s something like \(z_1\). That's \emph{alpha
