...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgd08846b}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org5cbf904}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org5cbf904}}

\subsection{``How did you write this?''}
\label{sec:org14c3c17}
...
\label{sec:orgec8f23a}

From the wiki page:\textsuperscript{\ref{orgd08846b}}
