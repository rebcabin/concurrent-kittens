...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org68d264a}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgc9f46e1}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgc9f46e1}}

\subsection{``How did you write this?''}
\label{sec:org2d21fb3}
...
\label{sec:org1488562}

From the wiki page:\textsuperscript{\ref{org68d264a}}
