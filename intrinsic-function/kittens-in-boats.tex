...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org6cd374e}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org6d94b18}} [\textit{sic}]
