...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org9b68cba}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgd60de29}} [\textit{sic}]
