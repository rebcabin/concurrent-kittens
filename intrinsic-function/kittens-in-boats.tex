...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org7c74300}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org9b77d5d}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org9b77d5d}}

\subsection{``How did you write this?''}
\label{sec:orgc10b275}
...
\label{sec:org3000ec1}

From the wiki page:\textsuperscript{\ref{org7c74300}}
