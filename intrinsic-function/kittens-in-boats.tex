...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgc3427bf}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgab31cd5}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgab31cd5}}

\subsection{``How did you write this?''}
\label{sec:org3ebf7bb}
...
\label{sec:org0989368}

From the wiki page:\textsuperscript{\ref{orgc3427bf}}
