...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org4645994}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org01e4320}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org01e4320}}

\subsection{``How did you write this?''}
\label{sec:org2bb0a90}
...
\label{sec:orgf073d48}

From the wiki page:\textsuperscript{\ref{org4645994}}
