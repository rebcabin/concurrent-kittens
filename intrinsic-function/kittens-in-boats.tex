...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgdf590b2}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgc8d24bf}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgc8d24bf}}

\subsection{``How did you write this?''}
\label{sec:orge4f2dc1}
...
\label{sec:org2ff6e26}

From the wiki page:\textsuperscript{\ref{orgdf590b2}}
