...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org379edec}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org576f026}} [\textit{sic}]
