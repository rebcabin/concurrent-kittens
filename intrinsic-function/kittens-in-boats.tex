...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org017d070}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org9d697f7}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org9d697f7}}

\subsection{``How did you write this?''}
\label{sec:orgab1e9cd}
...
\label{sec:orgc5edba9}

From the wiki page:\textsuperscript{\ref{org017d070}}
