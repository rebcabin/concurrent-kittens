...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgb326c80}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org8b567fd}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org8b567fd}}

\subsection{``How did you write this?''}
\label{sec:orgdece0eb}
...
\label{sec:org8e1d107}

From the wiki page:\textsuperscript{\ref{orgb326c80}}
