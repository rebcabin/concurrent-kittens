...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgc7bccb7}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgb6e88ce}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgb6e88ce}}

\subsection{``How did you write this?''}
\label{sec:org12684ed}
...
\label{sec:org44ad290}

From the wiki page:\textsuperscript{\ref{orgc7bccb7}}
