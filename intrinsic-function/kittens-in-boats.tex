...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgaa3d3a4}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org0e38afa}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org0e38afa}}

\subsection{``How did you write this?''}
\label{sec:org1f50078}
...
\label{sec:org76da9d6}

From the wiki page:\textsuperscript{\ref{orgaa3d3a4}}
