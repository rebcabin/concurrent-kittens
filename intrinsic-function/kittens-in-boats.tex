...
\clearpage
\section{Prologue}
\label{sec:orgd4074e9}

I must confess a mild mental disability: when I see
mathematics or programs, I see drowning kittens, and I want to
save them.

\texttt{1+2*3}, five little kittens, \texttt{1}, \texttt{+}, \texttt{2}, \texttt{*},
\texttt{3}, drowning in a syntactical sea. Venus-the-boatwright
rises on her half-shell, fists full of bows and sterns. She
reaches down and builds little boats, each from a bow and a
stern. She puts some little kittens in each boat. Sometimes,
she puts another little boat in a boat in place of a kitten.
...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org62d1ef8}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org6f31eef}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org6f31eef}}

\newpage
\subsection{``How did you write this?''}
\label{sec:orgca64c87}
...
\label{sec:org5ca784d}

From the wiki page:\textsuperscript{\ref{org62d1ef8}}
