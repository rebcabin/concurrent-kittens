...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org9df433c}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgc7457f0}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgc7457f0}}

\subsection{``How did you write this?''}
\label{sec:org242f998}
...
\label{sec:orgb265671}

From the wiki page:\textsuperscript{\ref{org9df433c}}
