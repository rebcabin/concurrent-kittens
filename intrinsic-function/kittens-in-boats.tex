...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgc558ece}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgb708310}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgb708310}}

\subsection{``How did you write this?''}
\label{sec:orgc5aedf3}
...
\label{sec:org584a6dd}

From the wiki page:\textsuperscript{\ref{orgc558ece}}
