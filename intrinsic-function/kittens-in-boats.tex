...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org7202b00}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org34c7932}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org34c7932}}

\subsection{``How did you write this?''}
\label{sec:org81a97d9}
...
\label{sec:org3f0ac3a}

From the wiki page:\textsuperscript{\ref{org7202b00}}
