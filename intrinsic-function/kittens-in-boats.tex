...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{orgd4279ea}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org9ec1012}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org9ec1012}}

\subsection{``How did you write this?''}
\label{sec:orga255044}
...
\label{sec:orgd499f87}

From the wiki page:\textsuperscript{\ref{orgd4279ea}}
