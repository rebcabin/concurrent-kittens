...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org23a8cfb}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{orgecc9878}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{orgecc9878}}

\subsection{``How did you write this?''}
\label{sec:org09c9aa4}
...
\label{sec:org121a45e}

From the wiki page:\textsuperscript{\ref{org23a8cfb}}
