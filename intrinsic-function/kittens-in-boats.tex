...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org2fab5c1}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org16089e5}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org16089e5}}

\subsection{``How did you write this?''}
\label{sec:org785b0d8}
...
\label{sec:orgb5572b3}

From the wiki page:\textsuperscript{\ref{org2fab5c1}}
