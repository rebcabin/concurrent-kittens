...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org1278632}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org265646f}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org265646f}}

\subsection{``How did you write this?''}
\label{sec:org40120e2}
...
\label{sec:org105d119}

From the wiki page:\textsuperscript{\ref{org1278632}}
