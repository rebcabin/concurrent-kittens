...
and the pi calculus\footnote{\url{https://en.wikipedia.org/wiki/\%CE\%A0-calculus}\label{org2229de2}}
...
lcompilers\footnote{\url{https://github.com/lcompilers}\label{org0fc5853}} [\textit{sic}]
...
for lfortran and lpython.\textsuperscript{\ref{org0fc5853}}

\subsection{``How did you write this?''}
\label{sec:org7c36b78}
...
\label{sec:orgf1c34d3}

From the wiki page:\textsuperscript{\ref{org2229de2}}
